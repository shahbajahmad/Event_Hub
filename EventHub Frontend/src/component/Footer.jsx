      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 w-52 sm:w-48 md:mb-0">
            <a href="/" className="flex items-center">
              <img src="/images/Logo.png" className="me-3" alt="Company Logo" />
            </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold uppercase text-white">Connect with Us</h2>
              <ul className="text-gray-400 font-medium">
                <li className="mb-4">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-400 sm:text-center">
            © 2023 <a href="/" className="hover:underline">Event Hub</a>. All Rights Reserved.
          </span>
