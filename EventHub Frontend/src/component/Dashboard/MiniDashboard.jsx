...
<Grid container spacing={3} sx={{ padding: 2 }} className='flex items-center justify-center'>
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          >
               <div ><Typography variant="h6" className=" font-medium">TOTAL REVENUE</Typography>
           <Typography variant="h5" >{totalSales}</Typography></div> 
             <div className="flex justify-center items-center h-12 w-12 rounded-full bg-green-100">   <AttachMoneyIcon color="success" /></div>
